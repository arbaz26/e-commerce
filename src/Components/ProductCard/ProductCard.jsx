    ...
    <>
    {
        products.map((product)=>{
            ...
            return(
                ...
                <Link to={`products/${id}`} className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                ...
                <div className="mt-4 px-5 pb-5">
                    ...
                    <Link onClick={()=>handleCart(product)}   className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
