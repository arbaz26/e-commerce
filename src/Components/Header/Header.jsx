            ...
            <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
                {
                    navigations.map((navigation)=>{
                        return(
                            <Link to={navigation.path}> <li className="text-gray-600 md:mr-12 hover:text-blue-600"> {navigation.name} </li></Link>
                        )
                    })
                }
                {/* <li className="text-gray-600 md:mr-12 hover:text-blue-600"> <Link to={'/'} >Home</Link> </li>
                <li className="text-gray-600 md:mr-12 hover:text-blue-600"> <Link to={'/products'}>Products</Link> </li>
                <li className="text-gray-600 md:mr-12 hover:text-blue-600"> <Link to={'/categories'}>Categories</Link> </li> */}
                ...
                <li className="text-gray-600 md:mr-12 hover:text-blue-600">
                <Link to={'/cart'}> <button className="rounded-md border-2 border-blue-600 px-6 py-1 font-medium text-blue-600 transition-colors hover:bg-blue-600 hover:text-white">Cart</button></Link>
                </li>
            </ul>
            </nav>
        </div>
